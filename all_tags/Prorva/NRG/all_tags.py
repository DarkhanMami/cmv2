...
try:
    ...
    A = open('all_tags/Prorva/NRG/tags.txt', 'r')
    ...
    conn.close()
    opc.close()
    C = open('all_tags/Prorva/NRG/numberOfRetries.txt', 'r')
    ...
    B = open("all_tags/Prorva/NRG/log.txt", "a")
    C = open('all_tags/Prorva/NRG/numberOfRetries.txt', 'r')
    numberOfRetries = int(C.read())
    C.close()
    ...
    if (numberOfRetries > 20):
        ...
        numberOfRetries = 0
    C = open('all_tags/Prorva/NRG/numberOfRetries.txt', 'w')
