...
class WellMatrix(models.Model):
    ...
    filling = models.FloatField(default=0, verbose_name=_('Заполн. насоса'))
    fluid_agzu = models.FloatField(default=0, verbose_name=_('Жидк. (АГЗУ)'))
    fluid_isu = models.FloatField(default=0, verbose_name=_('Жидк. (ИСУ)'))
    teh_rej_fluid = models.FloatField(default=0, verbose_name=_('Т/р жидкости'))
    teh_rej_oil = models.FloatField(default=0, verbose_name=_('Т/р нефти'))
    teh_rej_water = models.FloatField(default=0, verbose_name=_('Обводн.'))
    park_fluid = models.FloatField(default=-1, verbose_name=_('Парк. жидкость'))
    park_oil = models.FloatField(default=-1, verbose_name=_('Парк. нефть'))
    ...
    pump_speed = models.FloatField(default=1, verbose_name=_('Скорость ст.кач.'))
    electric_cons = models.FloatField(default=1, verbose_name=_('Потр. электр.'))
    tbd_fluid = models.FloatField(default=-1, verbose_name=_('ТБД жидк.'))
    status = models.CharField(blank=True, null=True, max_length=30, verbose_name=_('Статус (тбд)'))
    p_zab = models.FloatField(default=0, verbose_name=_('Давл. (заб)'))
    p_plast = models.FloatField(default=0, verbose_name=_('Давл. (пл)'))
