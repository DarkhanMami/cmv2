...
try:
    ...
    A = open('all_tags/Prorva/ATB/tags.txt', 'r')
    ...
    conn.close()
    opc.close()
    C = open('all_tags/Prorva/ATB/numberOfRetries.txt', 'r')
    ...
    B = open("all_tags/Prorva/ATB/log.txt", "a")
    C = open('all_tags/Prorva/ATB/numberOfRetries.txt', 'r')
    numberOfRetries = int(C.read())
    C.close()
    ...
    if (numberOfRetries > 20):
        ...
        numberOfRetries = 0
    C = open('all_tags/Prorva/ATB/numberOfRetries.txt', 'w')
