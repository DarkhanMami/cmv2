...
try:
    ...
    A = open('/webapps/cmv2/all_tags/Prorva/UPPV/tags.txt', 'r')
    ...
    conn.close()
    opc.close()
    C = open('/webapps/cmv2/all_tags/Prorva/UPPV/numberOfRetries.txt', 'r')
    ...
    B = open("/webapps/cmv2/all_tags/Prorva/UPPV/log.txt", "a")
    C = open('/webapps/cmv2/all_tags/Prorva/UPPV/numberOfRetries.txt', 'r')
    numberOfRetries = int(C.read())
    C.close()
    ...
    if (numberOfRetries > 20):
        ...
        numberOfRetries = 0
    C = open('/webapps/cmv2/all_tags/Prorva/UPPV/numberOfRetries.txt', 'w')
